...
void close(void)
{
    printf("\n\n\n\n ------------Thank you for visiting!!!------------ \n\n-----------Wear a mask and sanitize properly --------------\n\n--------------Stay safe, Stay healthy------------\n\n");
    }
void menu(void)
{ int choice;
system("cls");
...
int main()
{
char pass[20],password[20]="bctbproject", username[100];
system("color 6");
int i=0;
printf("\n\n\n\t\t\t\xB2\xB2\xB2\xB2\xB2\xB2\xB2 Bank Mangement System Portal \xB2\xB2\xB2\xB2\xB2\xB2\xB2");
printf("\n\n\n\n\n\t\t\t\tEnter your username:");
scanf("%s",username);
printf("\n\n\t\t\t\tEnter your password:");
scanf("%s",pass);
...
{ printf("\n\nWrong Username !!\a\a\a\n\nDisclaimer: Repeatedly trying to log in may lead to  suspension \n\nYour every activities is recorded in our system");
login_try:
